...
(gtk_accel_path "<Actions>/XfdesktopWindowIconManager/close" "<Super>q")
; (gtk_accel_path "<Actions>/XfdesktopIconView/unselect-all" "Escape")
(gtk_accel_path "<Actions>/XfdesktopFileIconManager/copy-2" "<Alt>w")
; (gtk_accel_path "<Actions>/XfdesktopIconView/activate" "space")
(gtk_accel_path "<Actions>/XfdesktopFileIconManager/cut-2" "<Primary>w")
...
(gtk_accel_path "<Actions>/XfdesktopFileIconManager/trash-3" "<Primary>d")
...
(gtk_accel_path "<Actions>/XfdesktopFileIconManager/paste-2" "<Primary>y")
...
(gtk_accel_path "<Actions>/XfdesktopFileIconManager/open-home" "<Shift><Super>v")
