...
(doom! :input
       ...
       :completion
       (company +childframe)          ; the ultimate code completion backend ; tng
       ...
       cc          ; C > C++ == 1 suddo apt-get install glslang-tools clangd
       ...
       (org +hugo +dragndrop +appear +pretty)              ; organize your plain life in plain text
